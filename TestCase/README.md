...
|---|---|---|
| Fig. 2, Fig. 3, Table 3, Table 5 | `Without-airInjection/` | Baseline cavitating hydrofoil case without air injection, with `Q = 0 L/min`. |
| Fig. 4–7, Fig. 9–13, Fig. 15–17, Table 6–9 | `With-airInjection_FROM_Tap1_Q1LperMin/` | Main air-injection case with `Q = 1 L/min`, using injection through Tap 1. |
| Fig. 14 | `With-airInjection_FROM_Tap5_Q1LperMin/` | Additional validation case with `Q = 1 L/min`, using injection through Tap 5 for comparison with the corresponding experimental cavitation-area data. |
